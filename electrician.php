...
<div class="container">
    <div class="row">
       <div class="card">
              <img  src="plum1.jpg" alt="Dharmesh" style="width: 100%">
        </div>
        <div class="detail">
             <h3>Dharmesh Shah </h3>
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum2.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Shubh Mishra</h3>
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum3.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Ravesh Singh </h3>
                  <div class="stars" data-rating="3">
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum4.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Dharmesh Shah </h3>
                  <div class="stars" data-rating="4">
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum5.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Dharmesh Shah </h3>
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum6.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Dharmesh Shah </h3>
                  <div class="stars" data-rating="2">
    ...
    <div class="row">
            <div class="card">
                   <img  src="plum7.jpg" alt="Dharmesh" style="width: 100%">
             </div>
             <div class="detail">
                  <h3>Dharmesh Shah </h3>
